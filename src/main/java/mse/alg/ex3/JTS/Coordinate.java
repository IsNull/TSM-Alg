 ...
 * It is distinct from {@link com.vividsolutions.jts.geom.Point}, which is a subclass of {@link com.vividsolutions.jts.geom.Geometry}.
 * Unlike objects of type {@link com.vividsolutions.jts.geom.Point} (which contain additional
...
public class Coordinate implements Comparable, Cloneable, Serializable {
   ...
   */
  public double distance3D(Coordinate p) {
    double dx = x - p.x;
    double dy = y - p.y;
    double dz = z - p.z;
